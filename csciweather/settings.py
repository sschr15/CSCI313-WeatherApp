"""
Django settings for csciweather project.
...
SECRET_KEY = 'django-insecure-ha16t=m#j=xfa2sx=3z-1lq!u=8hgct8&7rh*ed42&8@i%fp%l'
...
WSGI_APPLICATION = 'csciweather.wsgi.application'
